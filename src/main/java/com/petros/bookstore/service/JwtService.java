 ...
 * It uses the user's details to embed claims like username, user ID, and roles into the token payload.
 */
...
public class JwtService {
     ...
     *   <li><b>roles</b>: a list containing the user's role, prefixed with "ROLE_"</li>
     * </ul>
     *
