...
public class FavouriteBookService {
     ...
     * @param request The favourite book request containing the book ID.
     ...
     * @throws ResourceAlreadyExistsException   If the book is already marked as favourite by the user.
     */
    @Transactional
     ...
     * @throws ResourceNotFoundException If the user is not found or the favourite does not exist.
     */
    @Transactional
