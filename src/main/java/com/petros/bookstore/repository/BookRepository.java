...
public interface BookRepository extends JpaRepository<Book, Long> {
    ...
    /**
     * Searches for books with optional filtering by title, author, genre, availability, and price range.
     * All filters are applied only if their corresponding parameters are not null.
     *
