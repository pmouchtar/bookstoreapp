 ...
 * Authentication is injected by the DummyJwtFilter through header X-USER-ID.
 */
...
class ShoppingCartIntegrationTest extends AbstractPostgresContainerTest {
    ...
    void addItemToCart_ShouldReturn200_AndPersist() {
        ...
        ResponseEntity<CartItemResponseDto> res = restTemplate.postForEntity("/users/me/shopping-cart/items", entity,
    ...
    void addItemToCart_BookDoesNotExist_ShouldReturn404() {
        ...
        ResponseEntity<String> res = restTemplate.postForEntity("/users/me/shopping-cart/items", entity, String.class);
    ...
    void getCartItemById_ShouldReturnItem() {
        ...
        ResponseEntity<CartItemResponseDto> res = restTemplate.exchange("/users/me/shopping-cart/items/{itemId}",
                HttpMethod.GET, entity, CartItemResponseDto.class, itemId);
    ...
    void updateCartItem_ShouldModifyQuantity() {
        ...
        ResponseEntity<CartItemResponseDto> res = restTemplate.exchange("/users/me/shopping-cart/items/{id}",
                HttpMethod.PUT, entity, CartItemResponseDto.class, itemId);
    ...
    void updateCartItem_NotFound_ShouldReturn404() {
        ...
        ResponseEntity<String> res = restTemplate.exchange("/users/me/shopping-cart/items/{id}", HttpMethod.PUT, entity,
                String.class, 9_999L);
    ...
    void deleteCartItem_ShouldReturn204_AndRemove() {
        ...
        ResponseEntity<Void> del = restTemplate.exchange("/users/me/shopping-cart/items/{id}", HttpMethod.DELETE,
                entity, Void.class, itemId);
    ...
    void deleteCartItem_NotFound_ShouldReturn404() {
        ...
        ResponseEntity<String> res = restTemplate.exchange("/users/me/shopping-cart/items/{id}", HttpMethod.DELETE,
                entity, String.class, 8_888L);
    ...
    void adminGetUserCartItems_ShouldReturnPage() {
        ...
        ResponseEntity<Map<String, Object>> res = restTemplate.exchange("/users/{userId}/shopping-cart/items",
    ...
    private Map<String, Object> getUserCartPage() {
        HttpEntity<Void> entity = new HttpEntity<>(userHeaders);
        ResponseEntity<Map<String, Object>> res = restTemplate.exchange("/users/me/shopping-cart/items", HttpMethod.GET,
