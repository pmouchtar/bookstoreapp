...
class BookRepositoryIT extends AbstractPostgresContainerTest {
    ...
    void testSearchBooksByTitle() {
        Page<Book> result = bookRepository.searchBooks("Spring", null, null, null, null, null, PageRequest.of(0, 10));
    ...
    void testSearchBooksWithPriceRange() {
        Page<Book> result = bookRepository.searchBooks(null, null, null, null, 40.0, 50.0, PageRequest.of(0, 10));
    ...
    void testSearchBooksWithMultipleFilters() {
        Page<Book> result = bookRepository.searchBooks("Java", "John Doe", Genre.TECH, 5, 30.0, 40.0,
                PageRequest.of(0, 10));
    ...
    void testSearchBooksWithAllNullFiltersReturnsAll() {
        Page<Book> result = bookRepository.searchBooks(null, null, null, null, null, null, PageRequest.of(0, 10));
    ...
    void testSearchBooksWithNoMatchReturnsEmpty() {
        Page<Book> result = bookRepository.searchBooks("Nonexistent", "Nobody", Genre.HISTORY, 100, 100.0, 200.0,
                PageRequest.of(0, 10));
    ...
    void testSearchBooksByGenre() {
        Page<Book> result = bookRepository.searchBooks(null, null, Genre.TECH, null, null, null, PageRequest.of(0, 10));
    ...
    void testSearchBooksPagination() {
        // Page 0, size 1
        Page<Book> page1 = bookRepository.searchBooks(null, null, null, null, null, null, PageRequest.of(0, 1));

        // Page 1, size 1
        Page<Book> page2 = bookRepository.searchBooks(null, null, null, null, null, null, PageRequest.of(1, 1));
