...
public class BookServiceIT extends AbstractPostgresContainerTest {
    ...
    void setUp() {
        ...
        bookRequestDto = new BookRequestDto("Simple Book", "John Doe", "simple description", 9.99, 100, Genre.DRAMA);
        bookService.save(bookRequestDto);
        bookRequestDto2 = new BookRequestDto("Another Book", "Jane Doe", "another description", 19.99, 50,
    ...
    void testDeleteBook() {
        ...
        assertThatThrownBy(() -> bookService.findBookById(saved.id())).isInstanceOf(RuntimeException.class);
    }

    @Test
    void testSearchBooks() {
        Page<BookResponseDto> results = bookService.searchBooks("Simple", "John", 100, Genre.DRAMA, 5.0, 15.0,
                PageRequest.of(0, 10));
