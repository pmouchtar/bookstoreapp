...
public class BookIntegrationTest extends AbstractPostgresContainerTest {
  ...
  void testDeleteBook() throws Exception {
    ...
    ResponseEntity<Void> deleteResponse =
        client.exchange("/books/" + id, HttpMethod.DELETE, null, Void.class);
  ...
  void testSearchBooks_InvalidPriceType() {
    ...
    Assertions.assertTrue(
        responseBody.contains(
            "Invalid value 'cheap' for parameter 'minPrice'. Expected type: Double."));
  }
  ...
  void testDeleteBookById_NotFound() {
    ...
    ResponseEntity<String> response =
        client.exchange("/books/99999", HttpMethod.DELETE, null, String.class);
