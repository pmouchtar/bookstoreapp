...
class OrderAdminControllerTest {
    ...
    void getOrderById_success() throws Exception {
        ...
        mockMvc.perform(get("/orders/{orderId}", 1L))
                ...
                .andExpect(jsonPath("$.userId").value(order.userId()))
    ...
    void updateOrderStatus_success() throws Exception {
        ...
        Mockito.when(orderService.updateOrderStatus(eq(1L), any(OrderStatusUpdateRequestDto.class)))
                .thenReturn(order);
    ...
    void getUserOrders_success() throws Exception {
        ...
        mockMvc.perform(get("/users/{userId}/orders", 10L)
                        .param("page", "0").param("size", "10"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.content[0].id").value(order.id()))
